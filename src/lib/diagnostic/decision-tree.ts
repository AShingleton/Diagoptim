...
export const SCOPING_QUESTIONS: QuestionNode[] = [
  ...
  {
    id: 'scoping_5w2h_what',
    textFr: 'Quel processus ou tâche précise aimeriez-vous automatiser en priorité ? Décrivez-le en une phrase.',
    textEn: 'Which specific process or task would you most want to automate? Describe it in one sentence.',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
  ...
  {
    id: 'scoping_5w2h_when',
    textFr: 'À quelle fréquence et à quel moment cette tâche a-t-elle lieu ? (à chaque commande, tous les matins…)',
    textEn: 'How often and when does this task happen? (each order, every morning…)',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
  ...
  {
    id: 'scoping_5w2h_why',
    textFr: 'Pourquoi cette tâche se fait-elle de cette manière aujourd\'hui ? (une vraie raison, ou l\'habitude ?)',
    textEn: 'Why is this task done this way today? (a real reason, or habit?)',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: '5W2H — Pourquoi.',
    hintEn: '5W2H — Why.',
  },
  {
    id: 'scoping_5w2h_howmuch_time',
    textFr: 'Combien de temps cette tâche vous prend-elle au total par semaine ? (une estimation suffit)',
    textEn: 'How much time does this task take you in total per week? (an estimate is fine)',
    type: 'text',
    category: 'measurement',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: '5W2H — Combien (temps).',
    hintEn: '5W2H — How much (time).',
  },
  {
    id: 'scoping_5w2h_howmuch_volume',
    textFr: 'Quel volume est concerné ? (nombre de commandes, de documents ou de clients par jour ou par semaine)',
    textEn: 'What volume is involved? (orders, documents or clients per day or week)',
    type: 'text',
    category: 'measurement',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: '5W2H — Combien (volume).',
    hintEn: '5W2H — How much (volume).',
  },
  {
    id: 'scoping_waste_transport',
    textFr: 'Des documents ou informations circulent-ils entre plusieurs personnes ou outils de façon inutile ?',
    textEn: 'Do documents or information move between people or tools unnecessarily?',
    type: 'text',
    category: 'environment',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Transport.',
    hintEn: 'Waste — Transport.',
  },
  {
    id: 'scoping_waste_inventory',
    textFr: 'Y a-t-il des accumulations : stocks, dossiers en attente, emails ou commandes non traités ?',
    textEn: 'Are there accumulations: stock, pending files, unhandled emails or orders?',
    type: 'text',
    category: 'material',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Stocks.',
    hintEn: 'Waste — Inventory.',
  },
  {
    id: 'scoping_waste_motion',
    textFr: 'Devez-vous vous déplacer, chercher des informations, ou jongler entre plusieurs écrans ou outils ?',
    textEn: 'Do you have to move around, search for info, or juggle several screens or tools?',
    type: 'text',
    category: 'environment',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Mouvements.',
    hintEn: 'Waste — Motion.',
  },
  {
    id: 'scoping_waste_waiting',
    textFr: 'Y a-t-il des temps d\'attente : validation, réponse d\'un collègue, information manquante ?',
    textEn: 'Are there waiting times: approval, a colleague\'s reply, missing information?',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Attentes.',
    hintEn: 'Waste — Waiting.',
  },
  {
    id: 'scoping_waste_overproduction',
    textFr: 'Préparez-vous ou produisez-vous des choses en avance ou en plus grande quantité que nécessaire ?',
    textEn: 'Do you prepare or produce things in advance or in larger quantity than needed?',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Surproduction.',
    hintEn: 'Waste — Overproduction.',
  },
  {
    id: 'scoping_waste_overprocessing',
    textFr: 'Faites-vous des étapes qui semblent superflues, redondantes ou trop complexes ?',
    textEn: 'Do you perform steps that seem superfluous, redundant or overly complex?',
    type: 'text',
    category: 'method',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Sur-traitement.',
    hintEn: 'Waste — Overprocessing.',
  },
  {
    id: 'scoping_waste_defects',
    textFr: 'Quelles erreurs, oublis ou corrections reviennent le plus souvent ?',
    textEn: 'Which errors, omissions or rework recur most often?',
    type: 'text',
    category: 'measurement',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Défauts.',
    hintEn: 'Waste — Defects.',
  },
  {
    id: 'scoping_waste_skills',
    textFr: 'Y a-t-il des compétences sous-utilisées, ou des tâches mal réparties (trop simples ou trop complexes pour qui les fait) ?',
    textEn: 'Are there under-used skills, or poorly allocated tasks (too simple or too complex for who does them)?',
    type: 'text',
    category: 'man',
    phase: 'scoping',
    scoringWeight: 0,
    hintFr: 'Gaspillage — Compétences.',
    hintEn: 'Waste — Skills.',
  },

  // ==========================================================================
  // STRATEGIC BLOCKS (SP-STRAT-2) — gated by project altitude × respondent role.
  // Only served on strategique projects, to direction-level respondents
  // (except the SBS value-stream question, encadrement+ on processus+ projects).
  // ==========================================================================

  // --- STEEPLE (macro-environment scan) ---
  { id: 'scoping_steeple_social', textFr: 'Sociétal : quelles évolutions sociales/démographiques ou attentes clients impactent ce projet ?', textEn: 'Social: which social/demographic shifts or customer expectations affect this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Société.', hintEn: 'STEEPLE — Social.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_technological', textFr: 'Technologique : quelles technologies (IA, outils, plateformes) ouvrent ou menacent ce projet ?', textEn: 'Technological: which technologies (AI, tools, platforms) enable or threaten this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Technologie.', hintEn: 'STEEPLE — Technology.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_economic', textFr: 'Économique : quel contexte économique (coûts, marché, financement) pèse sur ce projet ?', textEn: 'Economic: which economic context (costs, market, funding) weighs on this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Économie.', hintEn: 'STEEPLE — Economic.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_environmental', textFr: 'Environnemental : y a-t-il des enjeux écologiques / RSE liés à ce projet ?', textEn: 'Environmental: any ecological / CSR stakes tied to this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Environnement.', hintEn: 'STEEPLE — Environmental.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_political', textFr: 'Politique : des orientations publiques, aides ou marchés publics influencent-ils ce projet ?', textEn: 'Political: do public policies, subsidies or public tenders influence this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Politique.', hintEn: 'STEEPLE — Political.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_legal', textFr: 'Légal : quelles contraintes réglementaires (RGPD, normes, droit du travail) encadrent ce projet ?', textEn: 'Legal: which regulatory constraints (GDPR, standards, labour law) frame this project?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Légal.', hintEn: 'STEEPLE — Legal.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_steeple_ethical', textFr: 'Éthique : y a-t-il des enjeux éthiques (usage de l\'IA, transparence, impact emploi) à anticiper ?', textEn: 'Ethical: any ethical stakes (AI use, transparency, jobs impact) to anticipate?', type: 'text', category: 'steeple', phase: 'scoping', scoringWeight: 0, hintFr: 'STEEPLE — Éthique.', hintEn: 'STEEPLE — Ethical.', altitudeMin: 'strategique', roleMin: 'direction' },

  // --- Hoshin light (strategic alignment) ---
  { id: 'scoping_hoshin_objective', textFr: 'Quel est l\'objectif stratégique de l\'entreprise à 12-18 mois auquel ce projet doit contribuer ?', textEn: 'What is the company\'s 12-18 month strategic objective this project must contribute to?', type: 'text', category: 'hoshin', phase: 'scoping', scoringWeight: 0, hintFr: 'Hoshin — Objectif (True North).', hintEn: 'Hoshin — Objective.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_hoshin_truenorth', textFr: 'Quel indicateur True North ce projet sert-il en priorité ?', textEn: 'Which True North indicator does this project primarily serve?', type: 'choice', options: [ { value: 'human', labelFr: 'Développement humain', labelEn: 'Human development' }, { value: 'quality', labelFr: 'Qualité', labelEn: 'Quality' }, { value: 'delivery', labelFr: 'Ponctualité (délais)', labelEn: 'Delivery (timeliness)' }, { value: 'cost', labelFr: 'Coût', labelEn: 'Cost' } ], category: 'hoshin', phase: 'scoping', scoringWeight: 0, hintFr: 'Hoshin — True North (SBS).', hintEn: 'Hoshin — True North.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_hoshin_breakthroughs', textFr: 'Quelles sont les 1 à 3 percées prioritaires pour atteindre cet objectif cette année ?', textEn: 'What are the 1-3 breakthrough priorities to reach that objective this year?', type: 'text', category: 'hoshin', phase: 'scoping', scoringWeight: 0, hintFr: 'Hoshin — Percées.', hintEn: 'Hoshin — Breakthroughs.', altitudeMin: 'strategique', roleMin: 'direction' },

  // --- SWOT / TOWS ---
  { id: 'scoping_swot_strengths', textFr: 'Forces : sur quoi l\'entreprise peut-elle s\'appuyer (interne) pour réussir ce projet ?', textEn: 'Strengths: which internal strengths can the company rely on for this project?', type: 'text', category: 'swot', phase: 'scoping', scoringWeight: 0, hintFr: 'SWOT — Forces.', hintEn: 'SWOT — Strengths.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_swot_weaknesses', textFr: 'Faiblesses : quelles limites internes (compétences, outils, organisation) freinent ce projet ?', textEn: 'Weaknesses: which internal limits (skills, tools, organisation) hinder this project?', type: 'text', category: 'swot', phase: 'scoping', scoringWeight: 0, hintFr: 'SWOT — Faiblesses.', hintEn: 'SWOT — Weaknesses.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_swot_opportunities', textFr: 'Opportunités : quelles opportunités externes ce projet permet-il de saisir ?', textEn: 'Opportunities: which external opportunities does this project help seize?', type: 'text', category: 'swot', phase: 'scoping', scoringWeight: 0, hintFr: 'SWOT — Opportunités.', hintEn: 'SWOT — Opportunities.', altitudeMin: 'strategique', roleMin: 'direction' },
  { id: 'scoping_swot_threats', textFr: 'Menaces : quelles menaces externes pourraient compromettre ce projet ?', textEn: 'Threats: which external threats could jeopardise this project?', type: 'text', category: 'swot', phase: 'scoping', scoringWeight: 0, hintFr: 'SWOT — Menaces.', hintEn: 'SWOT — Threats.', altitudeMin: 'strategique', roleMin: 'direction' },
